...
(function() {
  ...
  Node = (function() {
    ...
    Node.prototype.insert = function(item) {
      var child, iheight, index, iwidth, ix, iy, node, _i, _len, _ref;
      ...
      if (!(this._depth >= this._maxDepth) && (this.children.length > this.maxChildren)) {
        this.subdivide();
        _ref = this.children;
  ...
  Kona.Scene = (function() {
    ...
    Scene.prototype.draw = function() {
      var entity;
      Kona.Canvas.clear();
      for (entity in this.entities.concat()) {
        if (entity != null) {
          if (!Kona.gamePaused) {
            entity.update();
          }
    ...
    Scene.prototype.findTile = function(opts) {
      ...
      _ref = Kona.Scenes.currentScene.tiles();
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tile = _ref[_i];
        if (tile.position.x === opts.x && tile.position.y === opts.y) {
          return tile;
        }
      }
      return null;
      ...
      if (this.hasLeftCollisions() || this.hasRightCollisions()) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (ent.solid && (leftHit || rightHit)) {
            if (this.target === ent || _.contains(this.destructibles, group)) {
              if (ent.hit != null) {
