...
Kona.Sprite = (function() {
  ...
  Sprite.prototype.draw = function(x, y, width, height) {
    return Kona.Canvas.ctx.drawImage(this.image, x, y, width, height);
  };
...
Kona.Entity = (function() {
  ...
  function Entity(opts) {
    ...
    this.sprite = new Kona.Sprite(opts.sprite);
  }
  ...
  Entity.prototype.draw = function() {
    return this.sprite.draw(this.position.x, this.position.y, this.box.width, this.box.height);
  };
...
Kona.Tile = (function(_super) {
  ...
  function Tile(opts) {
    ...
    this.sprite = new Kona.Sprite('img/tiles/dirt1.png');
...
Kona.EnemyWeapon = (function(_super) {
  ...
  EnemyWeapon.prototype.fire = function() {
    ...
    if (this.holder.active()) {
      ...
      return Kona.Scenes.currentScene.addEntity(proj);
    }
  };
