...
Kona.Entity = (function() {
  ...
  Entity.prototype.eachSolidEntity = function(fxn) {
    var col, ent, entities, tile, _i, _j, _k, _len, _len1, _len2, _ref, _results,
      _this = this;
    ...
    for (_k = 0, _len2 = entities.length; _k < _len2; _k++) {
      ent = entities[_k];
      if ((ent != null) && (ent.solid != null)) {
        _results.push(fxn(ent));
      } else {
        _results.push(void 0);
      }
    }
  ...
  Entity.prototype.isCollision = function(checkFxn) {
    var collision,
      _this = this;
    collision = false;
    this.eachSolidEntity(function(tile) {
      if (checkFxn(tile)) {
  ...
  Entity.prototype.onSurface = function() {
    var col, ent, entities, tile, _i, _j, _k, _len, _len1, _len2, _ref,
      _this = this;
    _ref = Kona.TileManager.columnsFor(this);
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      col = _ref[_i];
    ...
    for (_i = 0, _len = grid.length; _i < _len; _i++) {
      ...
      for (_j = 0, _len1 = row.length; _j < _len1; _j++) {
        ...
        tile = color === 0 ? new Kona.BlankTile({
          ...
          color: Kona.Utils.colorFor(color),
          x: x,
          y: y
        });
        rowBuffer.push(tile);
...
Kona.Tile = (function(_super) {
  ...
  Tile.prototype.toString = function() {
    return "<Tile @x=" + this.position.x + ", @y=" + this.position.y + ", @color=" + this.color + ">";
  };
